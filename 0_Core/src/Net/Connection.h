...
public:
	...
	bool Send(CMessageFactory& factory, std::vector<CMessage*>& messages, bool SPL = false);
	bool Receive(CMessageFactory& factory, std::vector<CMessage*>& messages, unsigned char* buffer, size_t size);
